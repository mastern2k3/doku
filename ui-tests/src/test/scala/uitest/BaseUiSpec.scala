...
import com.kaizoku.doku.email.application.DummyEmailService
import com.kaizoku.doku.passwordreset.application.SqlPasswordResetCodeSchema
import com.kaizoku.doku.user.application.SqlUserSchema
import com.kaizoku.doku.{DependencyWiring, Main}
