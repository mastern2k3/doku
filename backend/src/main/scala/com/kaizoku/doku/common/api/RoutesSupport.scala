package com.kaizoku.doku.common.api
...
import com.kaizoku.doku.common.api.`X-Content-Type-Options`.`nosniff`
import com.kaizoku.doku.common.api.`X-Frame-Options`.`DENY`
import com.kaizoku.doku.common.api.`X-XSS-Protection`.`1; mode=block`
import io.circe._
