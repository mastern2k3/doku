package com.kaizoku.doku.user.api

import akka.http.scaladsl.server.Directives._
import akka.http.scaladsl.server._
import com.kaizoku.doku.user.application.{Session, UserService}
import com.kaizoku.doku.user.domain.BasicUserData
import com.kaizoku.doku.user.UserId
